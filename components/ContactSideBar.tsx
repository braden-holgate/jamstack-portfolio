...
function ContactSideBar ({}: Props) {
  return (
    <div className='fixed flex items-center bottom-0 px-5 w-screen border border-solid border-lines xl:px-0 xl:top-14 xl:left-0 xl:w-14 xl:h-full xl:flex-col'>
